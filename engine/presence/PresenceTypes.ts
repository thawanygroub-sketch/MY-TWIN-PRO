...
export interface ConsciousnessSource { getState(): ConsciousnessState; subscribe(fn: (s: ConsciousnessState) => void): () => void; }
export interface PresenceState {
  ...
  colorA: { r: number; g: number; b: number }; colorB: { r: number; g: number; b: number }; eyeColor: { r: number; g: number; b: number };
